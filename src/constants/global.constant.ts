...
export const PRODUCT_DETAIL_CONTACT_INFO = {
  phone: "+91 (11) 2345-6789",
  email: "contact@maisonelegante.com",
  storeHours: "Mon-Sat 10:00 AM - 8:00 PM",
  message:
    "Contact our customer service team for personalized assistance and to check in-store availability.",
};
